...
namespace Northboundei.Mobile.Mvvm.ViewModels.Sections
{
    ...
    {
        [ObservableProperty]
        [NotifyPropertyChangedFor(nameof(AreSecondSignaturesVisible))]
        bool isTelehealthSelected;
        [ObservableProperty]
        ...
        [ObservableProperty]
        private ObservableCollection<IDrawingLine> _myLines;
        ...
        private bool AreSecondSignaturesVisible => !IsTelehealthSelected;
